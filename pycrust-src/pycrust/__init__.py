...
DATA_PATH  = pkg_resources.resource_filename('pycrust', 'data/')
L1pt0_FILE = pkg_resources.resource_filename('pycrust', 'data/litho_data.npz')
C1pt0_FILE = pkg_resources.resource_filename('pycrust', 'data/Crust1pt0-regionalisation.npz')
