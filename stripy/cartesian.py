...
_ier_codes = {0:  "no errors were encountered.",
              ...
              -2: "collinear nodes were encountered: either the first three "
                  "nodes lie on a common line, or TRMESH's incremental insertion "
                  "(ADDNOD) found all nodes up to some node to be collinear.\n"
                  "Set permute=True or reorder the nodes manually; if the error "
                  "persists the points may be (near-)collinear or degenerate.",
